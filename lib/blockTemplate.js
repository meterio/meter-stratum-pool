...
**/
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients, beneficiary){
    ...
    this.serializeCoinbase = function(extraNonce1, extraNonce2){
        // Yang:
        console.log("in serializeCoinbase rpcData.height:" + this.rpcData.height);
        console.log("beneficiary:" + this.beneficiary);
        /********
        var coinbaseBuf = new Buffer(24);
        var position = 0;

        coinbaseBuf.write(this.rpcData.height.toString(16), position, 4, 'hex');
        coinbaseBuf.write(this.beneficiary, position += 4, 20, 'hex');
        return coinbaseBuf;
        ************/ 
        return Buffer.concat([
